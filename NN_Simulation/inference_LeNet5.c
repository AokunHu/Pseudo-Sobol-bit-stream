...
)
{
	...
	for (i = start_idx; i <= end_idx; i++)
	{
		...
		prediction=LeNet5(input_data[i],weights_conv,bias_conv,weights_fc,bias_fc);
...
int main(void)
{
	...
	// conv1
	strcpy(filename_weight,"param_LeNet5/conv1_weights.txt");
	strcpy(filename_bias,"param_LeNet5/conv1_bias.txt");
	load_param_conv
	(
	...
	// conv2
	strcpy(filename_weight,"param_LeNet5/conv2_weights.txt");
	strcpy(filename_bias,"param_LeNet5/conv2_bias.txt");
	load_param_conv
	(
	...
	// fc1_bias
	strcpy(filename_weight,"param_LeNet5/fc1_weights.txt");
	strcpy(filename_bias,"param_LeNet5/fc1_bias.txt");
	...
	// fc2_bias
	strcpy(filename_weight,"param_LeNet5/fc2_weights.txt");
	strcpy(filename_bias,"param_LeNet5/fc2_bias.txt");
	...
	// fc3_bias
	strcpy(filename_weight,"param_LeNet5/fc3_weights.txt");
	strcpy(filename_bias,"param_LeNet5/fc3_bias.txt");
	...
	//err_core[0] = run_core(0,9999,input_data,label,weights_conv,bias_conv,weights_fc,bias_fc);
